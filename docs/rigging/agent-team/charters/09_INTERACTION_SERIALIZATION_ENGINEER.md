...
- **Required outputs:** Anchor contract, relation types, versioned pose/transfer contract, atomic-load rules, structured issues, and tests.
...
- **Acceptance criteria:** Stable local anchors; instance IDs for relationships; profile/rig/garment versions distinct; Placer adds panel data without rebuilding the rig.
