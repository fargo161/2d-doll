...
- **Required outputs:** Compatibility matrices, region rules, legal/conditional/forbidden states, structured issues, and fallback policies.
...
- **Acceptance criteria:** 3/4 is the only v0.1 bridge; direct Front/Back region transitions forbidden; limb seams coherent; head policy explicit.
