...
- **Required outputs:** Rig-root/segment/joint model, profile/artwork/presentation separation, typed connection zones, author-override/provenance boundaries, contracts, naming rules, and migration notes.
...
- **Acceptance criteria:** Stable semantic identity; future-profile extension; no filenames as identity; all downstream state attachable without arbitrary coordinates; generated and approved values remain distinguishable and reversible.
