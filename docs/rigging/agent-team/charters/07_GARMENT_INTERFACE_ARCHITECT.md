...
- **Required outputs:** Complete piece contract, three worked examples, profile/orientation compatibility, missing-asset policy, and fitting risks.
...
- **Acceptance criteria:** Primary ownership differs from secondary alignment; cross-joint pieces have seams/masks/correctives; states extend without schema forks.
